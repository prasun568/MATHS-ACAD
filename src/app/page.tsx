        ...
        <div className={`container ${styles.assessmentGrid}`}>
          <div className={styles.assessmentInfo}>
            ...
            <div className={styles.assessTrust}>
              <p>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" style={{ display: 'inline-block', verticalAlign: '-2px', marginRight: '8px', color: 'var(--secondary)' }}>
                  <path d="M22 10v6M2 10l10-5 10 5-10 5z"/>
                  <path d="M6 12v5c0 2 2 3 6 3s6-1 6-3v-5"/>
                </svg>
                Over 40+ points evaluated by verified education experts.
              </p>
            </div>
          </div>
